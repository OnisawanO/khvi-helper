...
- ทำเฉพาะงานที่ผู้ใช้สั่งและสิ่งที่จำเป็นโดยตรงต่อ acceptance criteria
- ไม่แก้ไฟล์หรือระบบส่วนอื่นเพียงเพราะพบว่าสามารถปรับปรุงได้
- สามารถแนะนำงานต่อเนื่องที่เกี่ยวข้องได้ แต่ต้องรอคำสั่งก่อนดำเนินการ
- หากสิ่งที่พบเป็น blocker ของงานหลัก ให้หยุดและแจ้งสาเหตุพร้อมทางเลือก
- สรุปแยกให้เห็นว่าอะไรทำแล้วและอะไรเป็นคำแนะนำที่ยังไม่ได้ทำ
