...
- คำขอ Scheduled ที่ยังไม่มีล่าม Claim ต้องหมดอายุ 24 ชั่วโมงหลังสร้างตาม requirement ปัจจุบัน
...
- Scheduled ที่ไม่มี Claim เปลี่ยนเป็น `expired` เมื่อครบ 24 ชั่วโมงหลังสร้าง
...
- Event ขั้นต่ำควรรวม Approve/Reject ใบสมัคร, ตอบ Help Request, ส่งต่อหรือปิด Report, เปลี่ยน role และ Lock/Unlock เมื่อเปิดใช้
...
- Lock/Unlock เป็นงานหลัง MVP และไม่ถือว่าเสร็จเพียงเพราะมี control ใน mock UI
