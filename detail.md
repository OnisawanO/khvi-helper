...
* **BR-10 (Requester Edit Window):** เจ้าของคำขอแก้ไขภาษา หมวดหมู่ รายละเอียด และจุดนัดพบได้ในสถานะ `Open` หรือ `Claimed` และแก้ไขไม่ได้ตั้งแต่สถานะ `InProgress` เป็นต้นไป
