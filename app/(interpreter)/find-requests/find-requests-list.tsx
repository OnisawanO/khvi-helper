      ...
      <div className="mx-auto max-w-[1180px]">
        ...
        {claimedRequestId && (
          <section className="mt-5 flex flex-col gap-3 rounded-(--khvi-radius-sm) border border-[#b7d9d2] bg-[#eef8f5] p-4 sm:flex-row sm:items-center sm:justify-between" role="status">
            ...
            <Link className="inline-flex h-10 items-center justify-center rounded-lg border border-[#6aa99f] px-4 text-xs font-extrabold text-[#205f5a] hover:bg-white" href="/my-assignments#main-content">{t.goAssignments}</Link>
          </section>
        )}
      </div>
