...
export function StoredRequestDetail({ requestId }: { requestId: string }) {
  ...
  return <main id="main-content" className="mx-auto w-full max-w-3xl flex-1 px-6 py-16">
    ...
    {ready && <><p className="my-4">Requests in this preview are saved in the browser where you created them.</p><Link className="underline" href="/my-requests">Back to my requests</Link></>}
  </main>;
}
