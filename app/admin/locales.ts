...
const translations: Record<Locale, AdminTranslation> = {
  en: {
    header: { subtitle: "Admin Dashboard", home: "KHVI Home", menu: "Toggle navigation menu", closeMenu: "Close menu", profile: "Profile", signOut: "Sign out", primaryAdmin: "Primary Admin", delegatedAdmin: "Delegated Admin", interfaceLanguage: "Interface language" },
  ...
  th: {
    header: { subtitle: "แดชบอร์ดผู้ดูแล", home: "หน้าหลัก KHVI", menu: "เปิดเมนูนำทาง", closeMenu: "ปิดเมนู", profile: "โปรไฟล์", signOut: "ออกจากระบบ", primaryAdmin: "ผู้ดูแลหลัก", delegatedAdmin: "ผู้ดูแลที่ได้รับมอบหมาย", interfaceLanguage: "ภาษาหน้าจอ" },
  ...
  zh: {
    header: { subtitle: "管理员面板", home: "KHVI 首页", menu: "切换导航菜单", closeMenu: "关闭菜单", profile: "个人资料", signOut: "退出登录", primaryAdmin: "主管理员", delegatedAdmin: "委派管理员", interfaceLanguage: "界面语言" },
  ...
  es: {
    header: { subtitle: "Panel de administración", home: "Inicio de KHVI", menu: "Alternar menú de navegación", closeMenu: "Cerrar menú", profile: "Perfil", signOut: "Cerrar sesión", primaryAdmin: "Administrador principal", delegatedAdmin: "Administrador delegado", interfaceLanguage: "Idioma de la interfaz" },
  ...
  ar: {
    header: { subtitle: "لوحة المسؤول", home: "صفحة KHVI الرئيسية", menu: "تبديل قائمة التنقل", closeMenu: "إغلاق القائمة", profile: "الملف الشخصي", signOut: "تسجيل الخروج", primaryAdmin: "المسؤول الرئيسي", delegatedAdmin: "المسؤول المفوض", interfaceLanguage: "لغة الواجهة" },
