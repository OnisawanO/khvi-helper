...
### 2.4 แถบแท็บที่ 1: รายชื่อผู้ใช้และการจัดการสิทธิ์ (All Users & Roles)
...
### 2.5 แถบแท็บที่ 2: ดัชนีคุณภาพและผลงานล่าม (Interpreter Index)
...
### 2.6 แถบแท็บที่ 3: บันทึกความปลอดภัยระบบ (Audit Trail)
...
### 2.7 หน้าต่างจัดการข้อมูลผู้ใช้แบบเจาะลึก (User Management Modal)
