-- Keep staff role elevation and Admin-level changes behind the Primary Admin.
-- The existing Admin read policy remains available to delegated Admin accounts.
